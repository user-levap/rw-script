...
- **Remnawave**: установка (с выбором версии и веб-сервера Nginx/Caddy), запуск/остановка, обновление, переустановка, логи, удаление
- **Remnanode**: установка (удалённая панель) с профилем из 4 протоколов (VLESS Reality TCP, gRPC, XHTTP + Hysteria2 с обфускацией), выбор squad'ов, запуск/остановка, обновление, переустановка, логи, удаление
...
- Рандомные шаблоны сайтов-заглушек (видео/игры/облачное хранилище) из [rw-templates](https://github.com/user-levap/rw-templates)
